...
public class ImbOperationsImpl implements ImbOperations {
    ...
    static {
        try {
            ...
            ImbOperationsImpl.schemagenBuildFile = new File(
                    "/Users/jccastrejon/java/workspace_IMB/InstanceModelBus.Roo/src/main/resources/schemagen.xml");
        } catch (Exception e) {
    ...
    public void updateControllers() {
        ...
        try {
            configurationPath = pathResolver
                    .getIdentifier(Path.SRC_MAIN_RESOURCES, "/mx/itesm/imb/configuration.properties");
    ...
    public void generatedNotificationScheduling() {
        ...
        this.createFile(schedulingConfiguration, "applicationContext_scheduling_template.xml");
        this.createFile(schedulingTask, "NotificationTask_template.java");
